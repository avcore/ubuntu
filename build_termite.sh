#!/bin/bash
#Termite terminal build and install script for Ubuntu. It is based on the terminal-install script, but statically link vte-ng so it does not mess up other vte based terminals.
